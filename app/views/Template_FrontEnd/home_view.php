<section id="main-slider" class="no-margin">
    <div class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active" style="background-image: url(<?php echo SITE_FRONT_ASSETSIMAGES; ?>/slider/bg5.png)">
                <div class="container">
                    ...
                    <div class="row slide-margin">
                        ...
                        <div class="col-sm-6">
                            <div class="carousel-content" style="margin-top:-40px">
                                ...
                                <h2 class="animation animated-item-2 ekip1">Yükseliyoruz</h2>
                            </div>
                        </div>
                    </div>
                </div>
            </div><!--/.item-->
            <div class="item" style="background-image: url(<?php echo SITE_FRONT_ASSETSIMAGES; ?>/slider/bg3.png)">
                <div class="container">
                    <div class="row slide-margin">
                        <div class="col-sm-6">
                            <div class="carousel-content " style="margin-top:-40px">
                                <h1 class="animation animated-item-1 kod1" >Etik ve Kaliteli Yazılımda</h1>
...
<section id="feature" >
    <div class="container">
        <div class="center wow fadeInDown"">
            <h2 style="color:#605F5F">Sunulan Hizmetler</h2>
        </div>
        <div class="row">
            <div class="features">
                ...
                <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                    <div class="feature-wrap">
                        ...
                        <h2 style=" color:#636363">Gelişmiş Arayüz</h2>
                    </div>
                </div><!--/.col-md-4-->
                <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                    <div class="feature-wrap">
                        ...
                        <h2 style=" color:#636363">Hızlı ve Kolay Tasarım</h2>
                    </div>
                </div><!--/.col-md-4-->
            </div><!--/.services-->
        </div><!--/.row-->    
            ...
            <div class="features">
                <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                    <div class="feature-wrap">
                        ...
                        <h2 style=" color:#636363">Mobil Destek</h2>
                    </div>
                </div><!--/.col-md-4-->
                <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                    <div class="feature-wrap">
                        <i class="fa fa-suitcase"></i></br></br>
                        <h2 style=" color:#636363">Üst Düzey Fikirler</h2>
                    </div>
                </div><!--/.col-md-4-->
                <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                    <div class="feature-wrap">
                        <i class="fa fa-dot-circle-o "></i></br></br>
                        <h2 style=" color:#636363">Mükemmel Çözümler</h2>
                    </div>
                </div><!--/.col-md-4-->
            </div><!--/.services-->
        </div><!--/.row--> 
        <div class="row" style="position:center">
            <div class="features ">
                <div class="col-md-2 hidden-xs" data-wow-duration="1000ms" data-wow-delay="600ms">
                </div><!--/.col-md-4-->
                <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                    <div class="feature-wrap">
                        <i class="fa fa-level-up "></i></br></br>
                        <h2 style="margin-top:2px; color:#636363">Verimli ve Kaliteli Yazılım</h2>
                    </div>
                </div><!--/.col-md-4-->
                <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                    <div class="feature-wrap">
                        <i class="fa fa-users "></i></br></br>
                        <h2 style=" color:#636363">Müşteri Memnuniyeti</h2>
                    </div>
                </div><!--/.col-md-4-->
                <div class="col-md-2 hidden-xs" data-wow-duration="1000ms" data-wow-delay="600ms">
                </div><!--/.services-->
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12">
                <div class="widget">
                    ...
                    <p style="text-align:center;text-indent:25px; font-size:16px; font-family:arial; color:#575555">
                        Aşık Veysel Bulvarı Erciyes Teknopark 5. Bina Zemin Kat No:36 Melikgazi/Kayseri
                    </p>
                    <p style="text-align:center;text-indent:25px; font-size:16px; font-family:arial; color:#575555">
