<section id="portfolio">
    <div class="container">
        ...
        <ul class="portfolio-filter text-center" style="margin-top:-25px">
            ...
            <li><a class="btn btn-default" href="#" data-filter=".özel">Özel Ürünler</a></li>
                        ...
                        <img class="img-responsive" src="images/portfolio/recent/item13.png" alt="">
                            <div class="overlay">
                                <div class="recent-work-inner">
                                    ...
                                    <p>Servis firmalarının yönetimi ve velilerin çocuğunu takip etmesi artık çok kolay</p>
                                    <a class="preview" target="_blank"  href="http://www.shuttleoperator.com" ><i class="fa fa-eye"></i> İNCELEYİN</a>
                                </div> 
                            </div>
                    </div>
                </div><!--/.portfolio-item-->
                        ...
                        <img class="img-responsive" src="images/portfolio/recent/item16.png" alt="">
                            <div class="overlay">
                                <div class="recent-work-inner">
                                    ...
                                    <p>Özgün tasarım ve hızı ile şu anda yayında olan bir e-ticaret sitesi</p></br></br>
                                    <a class="preview" target="_blank"  href="http://www.turkiyefloracicek.com" ><i class="fa fa-eye"></i>İNCELEYİN</a>
                                </div> 
                            </div>
                    </div> 
                                    ...
                                    <div class="col-sm-12 col-xs-8">
                                        <div class="social">
                                            <ul class="social-share">
                                                <li id="facebook"><a  href="https://www.facebook.com/lutimark" target="_blank" style="background-color:#009933"><i class="fa fa-facebook "></i></a></li>
                                                <li id="twitter"><a href="https://twitter.com/lutimarketible?lang=tr" target="_blank" style="background-color:#009933"><i class="fa fa-twitter"></i></a></li>
                                                <li id="youtube"><a href="https://www.youtube.com/channel/UC1GNdT_IjsVR27ouJ3QvC4A" target="_blank" style="background-color:#009933"><i class="fa fa-youtube-play"></i></a></li> 
                                                <li id="instagram"><a href="https://www.instagram.com/lutimark/" target="_blank" style="background-color:#009933"><i class="fa fa-instagram "></i></a></li>
                                            </ul>
                                            <div class="search">
                                                <form role="form">
                                                    <input  type="text" class="search-form" autocomplete="off" placeholder="Arama" >
                                                        <i class="fa fa-search" style="color:#009933"></i>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <img class="img-responsive" src="images/portfolio/recent/item19.png" alt="">
                            <div class="overlay">
                                <div class="recent-work-inner">
                                    ...
                                    <p>Kendine özgü özellikleri ile geliştirilmiş bir web sitesi </p>
                                    <a class="preview" target="_blank"  href="http://www.yeditepeteknikservis.com" ><i class="fa fa-eye"></i>İNCELEYİN</a>
                                </div> 
                            </div>
                    </div>          
                </div><!--/.portfolio-item-->
